...
<!-- <script type="text/javascript" src="<?php echo base_url(); ?>assets/dist/js/owl.carousel.js"></script> -->
<script type="text/javascript" src="<?php echo base_url(); ?>assets/dist/js/wow.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/dist/js/smooth-scroll.js"></script>
<script src="<?php echo base_url(); ?>assets/dist/preloader/js/classie.js"></script>
<script src="<?php echo base_url(); ?>assets/dist/preloader/js/pathLoader.js"></script>
<script src="<?php echo base_url(); ?>assets/dist/preloader/js/main.js"></script>
